...
def make_OK():
    ...
    info_text1 = tk.Text(window, width=10, height=1, relief='flat')
    info_text1.pack()
...
#--------------------------------------------------------------------------------------------------------
# fist level
btn_sample = tk.Button(window, text="NEW_FILE", bg='darkseagreen', fg='black', font=5, width=18, command=open_file)
btn_sample.place(x=50, y=50)
btn_sample = tk.Button(window, text="MAKE_SAMPLES", bg='darkseagreen', fg='black', font=5, width=18, command=MAKE_SAMPLES)
...
#second level
btn_sample = tk.Button(window, text="RAW INFORMATION", bg='darkseagreen', fg='black', width=17,  command=RAW_INFO)
btn_sample.place(x=300, y=50)
btn_sample = tk.Button(window, text="RAW STATISTIC", bg='darkgray', fg='black', width=17, command=RAW_INFO)
...
btn_sample = tk.Button(window, text="MAKE_OK", bg='darkseagreen', fg='black', width=17, command=make_OK)
btn_sample.place(x=300, y=230)
btn_sample = tk.Button(window, text="DATA PLOT", bg='darkturquoise', fg='black', width=17, command=data_plot)
btn_sample.place(x=300, y=270)
btn_sample = tk.Button(window, text="TOPO", bg='CornFlowerBlue', fg='black', width=17, command=topo_plot)
btn_sample.place(x=500, y=230)
btn_sample = tk.Button(window, text="PSD_TOPOMAP", bg='CornFlowerBlue', fg='black', width=17, command=psd_topomap)
btn_sample.place(x=500, y=270)

btn_sample = tk.Button(window, text="MUSIC EMOTION", bg='darkseagreen', fg='black', width=17,  command=Music_model)
...
btn_sample = tk.Button(window, text="RECOGNIZE", bg='darkseagreen', fg='black', width=17, command=Recognize)
